...
export class DemographicsPage {
  ...
  constructor(private navCtrl: NavController, public recordservice: RecordServiceProvider, private volunteerservice: VolunteerServiceProvider) {
    this.pageTitle = "Step 3: Demographics";
