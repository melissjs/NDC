...
import {AmendmentRecord} from '../../models/amendment-record';
...
export class AmendmentRecordPage {
  ...
  voteRecordKey: string;
      ...
      constructor(private navCtrl: NavController, private alertCtrl: AlertController, public volunteerservice: VolunteerServiceProvider, private recordservice: RecordServiceProvider, private restSvc: RestServiceProvider) {
      this.pageTitle = "Amendment Record";
      ...
      // testing
      // this.volunteerservice.setToVoidVolunteer();
    }
