...
export class RecordServiceProvider {
  ...
  constructor(private http: HttpClient, private pollingstationservice: PollingStationServiceProvider, 
    private volunteerservice: VolunteerServiceProvider, private alertCtrl: AlertController, private restSvc: RestServiceProvider) {
